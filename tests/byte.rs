...
fn little_endian() {
    ...
    tb! {
        ...
        LittleEndian::u16 => {
            s(0) => Err((0, e(Type::u16))),
            s(1) => Err((0, e(Type::u16))),
            s(2) => Ok((2, 54676)),
            s(3) => Ok((2, 54676)),
        },
        LittleEndian::u32 => {
            s(0) => Err((0, e(Type::u32))),
            s(1) => Err((0, e(Type::u32))),
            s(2) => Err((0, e(Type::u32))),
            s(3) => Err((0, e(Type::u32))),
            s(4) => Ok((4, 4054898068)),
            s(5) => Ok((4, 4054898068)),
        },
        LittleEndian::u64 => {
            s(0) => Err((0, e(Type::u64))),
            s(1) => Err((0, e(Type::u64))),
            s(2) => Err((0, e(Type::u64))),
            s(3) => Err((0, e(Type::u64))),
            s(4) => Err((0, e(Type::u64))),
            s(5) => Err((0, e(Type::u64))),
            s(6) => Err((0, e(Type::u64))),
            s(7) => Err((0, e(Type::u64))),
        ...
        LittleEndian::i16 => {
            s(0) => Err((0, e(Type::i16))),
            s(1) => Err((0, e(Type::i16))),
            s(2) => Ok((2, -10860)),
            s(3) => Ok((2, -10860)),
        },
        LittleEndian::i32 => {
            s(0) => Err((0, e(Type::i32))),
            s(1) => Err((0, e(Type::i32))),
            s(2) => Err((0, e(Type::i32))),
            s(3) => Err((0, e(Type::i32))),
            s(4) => Ok((4, -240069228)),
            s(5) => Ok((4, -240069228)),
        },
        LittleEndian::i64 => {
            s(0) => Err((0, e(Type::i64))),
            s(1) => Err((0, e(Type::i64))),
            s(2) => Err((0, e(Type::i64))),
            s(3) => Err((0, e(Type::i64))),
            s(4) => Err((0, e(Type::i64))),
            s(5) => Err((0, e(Type::i64))),
            s(6) => Err((0, e(Type::i64))),
            s(7) => Err((0, e(Type::i64))),
            s(8) => Ok((8, -33892828418353772)),
            s(9) => Ok((8, -33892828418353772)),
        },
        LittleEndian::f32 => {
            s(0) => Err((0, e(Type::f32))),
            s(1) => Err((0, e(Type::f32))),
            s(2) => Err((0, e(Type::f32))),
            s(3) => Err((0, e(Type::f32))),
            s(4) => Ok((4, -1.7512819788279716e30)),
            s(5) => Ok((4, -1.7512819788279716e30)),
        },
        LittleEndian::f64 => {
            s(0) => Err((0, e(Type::f64))),
            s(1) => Err((0, e(Type::f64))),
            s(2) => Err((0, e(Type::f64))),
            s(3) => Err((0, e(Type::f64))),
            s(4) => Err((0, e(Type::f64))),
            s(5) => Err((0, e(Type::f64))),
            s(6) => Err((0, e(Type::f64))),
            s(7) => Err((0, e(Type::f64))),
